<template>
    <div>
        ...
        <form>
            ...
            <div class="form-row">
                <div class="form-group col-md-2">
                    <label for="acceleration" class="label">Acceleration</label>
                ...
                <div class="form-group col-md-2">
                    <label for="efficiency" class="label">Efficiency</label>
                ...
                <div class="form-group col-md-2">
                    <label for="chargeSpeed" class="label">Charge Speed</label>
            ...
            <div class="form-row">
                <div class="form-group col-md-2">
                    ...
                    <input v-model="fields.drive" type="text" id="drive" name="drive" class="form-control" value="" placeholder="Drive" minlength="2" maxlength="100" required />
                ...
                <div class="form-group col-md-2">
                    ...
                    <input v-model="fields.segment" type="text" id="segment" name="segment" class="form-control" value="" placeholder="Segment" minlength="2" maxlength="100" required />
